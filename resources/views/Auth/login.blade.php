...
<html lang="en" style="height: 100%">
  ...
  <body class="d-flex justify-content-center align-items-center" style="width: 100%;height:100%">
    <div class="container" style="height: 80vh;width:70vw;">
        <form class=" border border-dark rounded p-4" method="POST" action="{{route('login.authenticate')}}">
          @csrf
          <div class="text-center">
            ...
            <div class="mb-3 form-check">
              <input type="checkbox" name="my_checkbox"  value="1" class="form-check-input" id="exampleCheck1" required>
            ...
            <div class="loginbutton text-center">
              <span>Don't have an account?<a href="{{route('signup')}}">Signup now</a></span>
            </div>
          </form>
    </div>
